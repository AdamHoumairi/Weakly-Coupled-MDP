...
#####################################################################################################################################################
  ...
  * File: "MDP_adv_map.py" contains the simulation and policy iteration for the toy sized model, as well as a deep exploration of the toy sized model for N=2, K=2 and K=4, it is a main file. This file provides the implementation used in the study reported in the paper: Hierarchical Dispatching: Exact MDP Optima and JSQ Failure Regions.
